 ...
 *
 * This project replicates an enterprise real-world situation, where a
 * deadlock can occur when using enterprise-style framework APIs.
 *
 * The framework being used here uses both the Clean and MVP
 * (model-view-presenter) architecture. This type of architectural style
 * is used predominantly by big companies like Google.
 *
 * @author Tyler Suehr
 * @author Win Ton
 * @author Steven Weber
...
public class Main {
     ...
     * running in different threads is what causes our deadlock to occur.
     *
